...
if "df" not in st.session_state:
    initial_data = [
            {"名前": "はるとくん", "身長": 175}, # 19歳
            {"名前": "さなちゃん", "身長": 167}, # 16歳、高1
            {"名前": "ごう",       "身長": 165}, # 13歳、中1
            {"名前": "りく",       "身長": 165}, # 13歳、中1
            {"名前": "ゆうだい",   "身長": 158}, # 13歳、中1
            {"名前": "ゆりりん",   "身長": 151}, # 13歳、中1
            {"名前": "ゆうあ",     "身長": 155}, # 13歳、中1
            {"名前": "おうすけ",   "身長": 155}, # 13歳、中1
            {"名前": "しりゅう",   "身長": 155}, # 12歳、小6
            {"名前": "あいな",     "身長": 140}, # 11歳、小5
            {"名前": "わっくん",   "身長": 155}, # 11歳、小5
            {"名前": "そうちゃん", "身長": 150}, # 11歳、小5
            {"名前": "ゆきちゃん", "身長": 135}, # 12歳、小6 
            {"名前": "みきちゃん", "身長": 130}, # 10歳、小4
            {"名前": "こっとん",   "身長": 140}, # 10歳、小4
            {"名前": "かずきくん", "身長": 135}, # 10歳、小4
            {"名前": "じゅんくん", "身長": 135}, # 10歳、小4
            {"名前": "えみこちゃん", "身長": 130}, # 8歳、小2
            {"名前": "みなこちゃん", "身長": 120}, # 7歳、小1
            {"名前": "みゆちゃん",   "身長": 135},
            {"名前": "みよりちゃん", "身長": 135},
            {"名前": "そうちゃん（2年生）", "身長": 135}, # 8歳、小2
        ]
